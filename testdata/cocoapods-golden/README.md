...
```
cocoapods-golden/
├── podfile/            # Podfile test files
├── podspec/            # .podspec test files
├── podspec.json/       # .podspec.json test files
├── podfile.lock/       # Podfile.lock test files
└── assemble/           # Complex multi-file scenarios
```
