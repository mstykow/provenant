...
Generated by `swift package dump-package` from raw `Package.swift` manifests before scanning.

Provenant scans these pre-generated JSON surfaces directly; it does not invoke SwiftPM during the
scan.
