...
fn generate_markdown() -> String {
    ...
    output.push_str("# Supported Package and Package-Adjacent Detection Surfaces\n\n");
    ...
    output.push_str("Provenant supports package manifests, installed-package metadata, recognizers, and a small number of detector-driven package-adjacent surfaces across multiple ecosystems.\n\n");
    output.push_str(
