...
5. **The default startup contract remains self-contained.**
   Built binaries load the compact embedded snapshot directly. This ADR does not require any
   persistent runtime cache to make embedded startup work.
...
- This ADR does not require a persistent runtime cache for license-engine startup.
