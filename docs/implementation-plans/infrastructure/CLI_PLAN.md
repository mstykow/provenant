...
| Flag                       | What it does                                        | Status          | Notes                                                                                                                                                                                                                                                                                 |
| -------------------------- | --------------------------------------------------- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `--cache-dir`              | Chooses the shared persistent cache root            | `Done`          | Root selector only; does not enable incremental reuse by itself. The same root now also stores license-index cache files.                                                                                                                                                             |
| `--cache-clear`            | Clears the selected persistent cache root           | `Done`          | Clears incremental and license-index cache state before scanning without implicitly enabling reuse.                                                                                                                                                                                   |
