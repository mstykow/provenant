...
| `--include-text`             | Legacy alias for matched license text output        | `Won't do` | Not part of the current ScanCode-facing CLI surface. Provenant should only expose the upstream public flag `--license-text`.                                                                        |
