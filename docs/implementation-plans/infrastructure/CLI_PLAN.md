...
| `--license-cache-dir` | Overrides the license index cache directory         | `Rust-specific` | Beyond-parity feature; defaults to the directory containing the provenant binary.                                                                                                                                                                                                     |
