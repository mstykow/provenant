...
> **Status**: 🟢 Complete maintained checklist — the current high-value CLI workflow parity rows are verified; keep using this file as the maintained end-to-end workflow checklist when future CLI surfaces or regressions need tracking beyond parser-family and output-format scorecards
