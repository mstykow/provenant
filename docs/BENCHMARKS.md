...
| `debian:bookworm-slim` rootfs `sha256:f06537653ac770703bc45b4b113475bd402f451e85223f0f2837acbf89ab020a`                     |  3267 | `macOS 26.3.1 · Apple M1 Max · 32 GB · arm64 · 9 proc` |        `21.05s` |      `156.25s` | `7.42×` faster (`-86.5%`)  | Same top-level package count (`88`) on both scanners, better Debian dependency hoisting from `dpkg/status`, source-faithful local-license resolution, and substantially cleaner common-profile author/email/url noise after rootfs-specific false-positive cleanup |
