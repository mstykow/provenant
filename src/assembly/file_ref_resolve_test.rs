...
#[test]
fn test_resolve_rpm_sqlite_file_references_from_legacy_var_lib_path() {
    let mut files = vec![
        FileInfo {
            name: "rpmdb.sqlite".to_string(),
            base_name: "rpmdb".to_string(),
            extension: ".sqlite".to_string(),
            path: "rootfs/var/lib/rpm/rpmdb.sqlite".to_string(),
        ...
        FileInfo {
            ...
            base_name: "COPYING".to_string(),
            extension: String::new(),
            path: "rootfs/usr/share/licenses/libgcc/COPYING".to_string(),
            file_type: FileType::File,
            mime_type: None,
            file_type_label: None,
            size: 10,
