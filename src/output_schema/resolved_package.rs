...
pub struct OutputResolvedPackage {
    #[serde(rename = "type")]
...
impl From<&crate::models::ResolvedPackage> for OutputResolvedPackage {
    fn from(value: &crate::models::ResolvedPackage) -> Self {
        Self {
...
impl TryFrom<&OutputResolvedPackage> for crate::models::ResolvedPackage {
    type Error = String;
    fn try_from(value: &OutputResolvedPackage) -> Result<Self, Self::Error> {
